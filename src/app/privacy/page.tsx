  ...
  return (
    <div className="container py-12 md:py-16">
      ...
      <div className="prose lg:prose-lg max-w-4xl mx-auto mt-8">
        <p>
          At Benched ("we", "us", "our"), we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and disclose your personal information in accordance with the <strong>Privacy Act 1988 (Cth)</strong> and the <strong>Australian Privacy Principles (APPs).</strong>
        </p>

        <h2>1. Information We Collect</h2>
        <p>We collect information that is necessary to provide our services to you as a specialized marketplace for performance gear and collector items. This includes:</p>
        <ul>
        ...
        <ul>
          <li>Facilitate the buying and selling of basketball gear and collector cards, including shipping and payments.</li>
        ...
        <p>
          ...
          <strong>Address:</strong> Benched, Perth, Western Australia
        </p>
      </div>
    </div>
  );
