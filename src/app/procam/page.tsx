...
export default function ProCamDashboard() {
      ...
      <header className="flex items-center justify-between p-4 border-b border-white/10 bg-zinc-900 sticky top-0 z-10">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex bg-zinc-800 rounded-full px-4 py-1.5 items-center gap-2 border border-white/5">
             ...
             <span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Pro Booth Connected</span>
          </div>
          <Button variant="ghost" size="icon" onClick={() => router.push('/procam/settings')} className="text-zinc-400 hover:text-white hover:bg-zinc-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
           <Card className="bg-primary text-black border-none shadow-glow overflow-hidden relative">
            ...
            <CardContent>
              ...
              <Button variant="secondary" className="w-full bg-black text-primary hover:bg-zinc-900 font-black uppercase text-xs border-none" onClick={() => router.push('/procam/capture')}>
          ...
          <Card className="bg-zinc-900 border-white/10 text-white shadow-sm">
            ...
            <CardContent>
              ...
              <Button variant="link" className="p-0 h-auto text-[10px] font-black uppercase mt-4 text-primary animate-pulse" onClick={() => router.push('/procam/review')}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="min-h-[300px] flex flex-col items-center justify-center text-center p-8 bg-zinc-900 border-dashed border-2 border-white/10 text-white">
              ...
              <h3 className="text-lg font-black uppercase tracking-tighter text-white">Ready for Product Batch</h3>
              <p className="text-xs text-zinc-400 max-w-xs mt-2 font-medium">
                High-resolution raw capture of 2 angles (Main and Secondary) with background cloud sync and Gemini auto-identification.
              </p>
              <Button className="mt-8 px-10 font-black uppercase tracking-widest h-12 bg-primary text-black hover:bg-primary/95" variant="default" onClick={() => router.push('/procam/capture')}>
            ...
            <Card className="bg-zinc-900 border-white/10 text-white">
              <CardContent className="pt-6 space-y-4">
                ...
                <div className="flex items-center justify-between border-t border-white/5 pt-4">
                  ...
                  <Badge variant="outline" className="bg-zinc-800 text-zinc-300 border-white/10 text-[8px] font-black uppercase tracking-widest">PRO-SCAN v1</Badge>
                </div>
              </CardContent>
            </Card>
          </div>
