  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-20">
      <header className="flex items-center justify-between p-4 border-b sticky top-0 bg-background/95 backdrop-blur-sm z-20">
        <Button variant="outline" size="icon" onClick={() => router.push('/procam')}>
        ...
        <Card className="shadow-lg border-primary/20">
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                <CardTitle className="text-2xl mb-2">ProCam Diagnostics</CardTitle>
                <CardDescription>
                  Verify that your ProCam app is correctly configured to communicate with the Benched.au backend.
                </CardDescription>
              </div>
              ...
              <div className="flex-1">
                ...
                {authStatus === 'success' ? (
                  ...
                  <div className="mt-2 text-sm">
                    ...
                    <p className="text-muted-foreground mt-1">You must be logged into ProCam via Firebase Auth to push listings to Benched.au.</p>
                  </div>
                ) : (
