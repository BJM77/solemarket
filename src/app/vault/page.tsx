    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="py-20 container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          ...
          <ProcessStep
            number="1"
            title="Agreement"
            desc="Buyer and Seller agree on a price. Buyer pays Benched (not the seller)."
      ...
      <section className="py-20 container max-w-3xl">
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          ...
          <FAQItem
            ...
            answer="The seller pays to ship the item to our Vault facility. Benched covers the insured shipping from the Vault to the Buyer."
          />
          <FAQItem
      ...
      <section className="py-24 bg-slate-900 text-white text-center">
        <div className="container max-w-4xl">
          ...
          <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">Join thousands of Australians who trust Benched Vault for their high-value collectibles.</p>
