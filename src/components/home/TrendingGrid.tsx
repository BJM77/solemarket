...
export default function TrendingGrid({ products, title = "Trending Near You", className = "bg-background py-16 lg:py-24 relative overflow-hidden" }: { products: Product[], title?: string, className?: string }) {
        ...
        <section className={className}>
            <div className="max-w-[1440px] mx-auto px-6 md:px-10 relative z-10">
                <div className={`flex flex-col md:flex-row ${title ? 'items-end' : 'items-end justify-end'} justify-between mb-12 gap-4`}>
                    ...
                    <Link href="/browse" className={`group hidden md:flex text-sm font-black tracking-widest uppercase text-primary hover:text-orange-400 items-center transition-all bg-primary/10 px-6 py-3 rounded-full hover:bg-primary/20 ${!title ? 'ml-auto' : ''}`}>
